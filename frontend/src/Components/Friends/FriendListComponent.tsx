        ...
        <div className="bg-glass/10 backdrop-blur-lg rounded-2xl p-6 text-light shadow-glow">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-glass/20 border border-glass/30 rounded-lg text-light placeholder:text-light/60 focus:outline-none focus:ring-2 focus:ring-accent/50 focus:border-accent/50 backdrop-blur-sm transition-all duration-200"
              value={searchTerm}
